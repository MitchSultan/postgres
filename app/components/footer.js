      ...
      <section className="py-10 bg-blue-900 sm:pt-16 lg:pt-24">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-12">
            <div>
              <img className="w-48 h-8 my-auto lg:h-24" src="/images/logo.svg" alt="" />

              <ul className="mt-8 space-y-4">
                <li>
                  <a href="/about" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> About </a>
                </li>

                <li>
                  <a href="/skills" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> skills </a>
                </li>

                <li>
                  <a href="/resources" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Resources </a>
                </li>

                <li>
                  <a href="/blog" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Blog </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-8 space-y-4">
                ...
                <li>
                  <a href="#" title="" className="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Gambler </a>
                </li>
          ...
          <div className="mt-20 md:mt-28 2xl:mt-32">
            <div className="lg:flex lg:items-center lg:justify-between">
              ...
              <p className="mt-6 text-sm text-blue-200 lg:mt-0">© Copyright 2024, All Rights Reserved by mitch.dev</p>
            </div>
          </div>
        </div>
      </section>
