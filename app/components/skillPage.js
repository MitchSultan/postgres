...
export default function SkillPage() {
  return (
    <div>
      <div className=" inset-0 bg-gradient-to-br from-blue-400 to-purple-500 animate-gradient-xy">
        
        <section className="relative  pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
          <div className="absolute inset-x-0 bottom-0 z-10 hidden ">
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div className="max-w-xl mx-auto text-center">
              <h1 className="text-4xl font-bold sm:text-6xl">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Secure way to buy & sell crypto </span>
              </h1>
