      ...
      <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">Hey, do you need to get in touch? Got a question about blogging or any of the services or products we recommend? Use the form below to send inquiries, issues, questions, or anything you would like</p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
              <div class="overflow-hidden bg-white rounded-xl">
                <div class="p-6">
                  ...
                  <p class="mt-6 text-lg font-medium text-gray-900">+254-703-666-366</p>
                  <p class="mt-1 text-lg font-medium text-gray-900">+2-547-036-66366</p>
                </div>
              </div>
              ...
              <div class="overflow-hidden bg-white rounded-xl">
                <div class="p-6">
                  ...
                  <p class="mt-6 text-lg font-medium text-gray-900">contact@kenyanbuzz.info</p>
                  <p class="mt-1 text-lg font-medium text-gray-900">hr@kenyanbuzz.info</p>
                </div>
              </div>
